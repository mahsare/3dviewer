...
gltfLoader.load("assets/bim/glTF/terrain.glb", (terrain) => {
...
gltfLoader.load("assets/bim/glTF/baseBuilding.glb", (baseBuilding) => {
...
gltfLoader.load(
  "assets/bim/glTF/surroundingBuildings.glb",
...
gltfLoader.load("assets/bim/glTF/trees.glb", (trees) => {
  // GUI
  sceneSetup
...
gltfLoader.load("assets/bim/glTF/glasses.glb", (glasses) => {
  // GUI
  sceneSetup
