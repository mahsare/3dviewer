...
import sensorsData from "../assets/varema/sensorsData";
...
gltfLoader.load("assets/varema/terrain.glb", (terrain) => {
...
gltfLoader.load("assets/varema/baseBuilding.glb", (baseBuilding) => {
...
gltfLoader.load(
  "assets/varema/surroundingBuildings.glb",
...
gltfLoader.load("assets/varema/trees.glb", (trees) => {
  // GUI
  sceneSetup
...
gltfLoader.load("assets/varema/glasses.glb", (glasses) => {
  // GUI
  sceneSetup
